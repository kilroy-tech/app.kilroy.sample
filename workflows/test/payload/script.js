/**
 * kilroy.sample/test.js - preflight/postflight functions for kilroy.sample/test
 * @module kilroy.sample/test
 * @file kilroy.sample/test preflight/postflight implementation
 * @author system
 * @copyright Copyright ©2023, Concluent Systems, LLC. All rights reserved.
 */
"use strict";
const MODULE_NAME = "workflow:kilroy.sample/test";
