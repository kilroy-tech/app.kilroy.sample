/**
 * kilroy.sample/manager/ui_new_widget.js - preflight/postflight functions for kilroy.sample/manager/ui_new_widget
 * @module kilroy.sample/manager/ui_new_widget
 * @file kilroy.sample/manager/ui_new_widget preflight/postflight implementation
 * @author system
 * @copyright Copyright ©2025, Concluent Systems, LLC. All rights reserved.
 */
"use strict";
const MODULE_NAME = "workflow:kilroy.sample/manager/ui_new_widget";
...
function begin (authData, wfProxy, step, theForm) {
    ...
    return new Promise( function(resolve, reject){
        try {
			...
			let settings = {};
			wfProxy.loadAppSettings (authData, "kilroy.sample")
			.then (data=>{
